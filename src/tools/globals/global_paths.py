...
CONTAINERS_DATA_DIR = os.path.join(RESOURCES_DIR, "containers/")
...
CREATURES_DATA_DIR = os.path.join(RESOURCES_DIR, "creatures/")
CREATURES_DATA_FILE = os.path.join(CREATURES_DATA_DIR, "creatures_data.json")

ITEMS_DATA_DIR = os.path.join(RESOURCES_DIR, "items/")
ITEMS_DATA_FILE = os.path.join(ITEMS_DATA_DIR, "items_data.json")

MAP_DATA_DIR = os.path.join(RESOURCES_DIR, "map/")
